  ...
  <div class="wallet-main-header"> 
    <div class="dropdown-wrapper menu-wrapper" v-click-outside="hideMenu">
      <div class="dropdown-toggle" @click="toggleMenu" v-if="!hideMenuToggle">
        <img src="../../static/logo.svg" alt="click show menu"/>
      </div>
      <div class="dropdown" v-show="showMenu">
        ...
        <div class="social-icon-container">
          <a class="wechat-link" href="JavaScript: void(0)">
            ...
            <img class="wechat-img" src="../../static/wechat.png"/>
          </a>
          <a href="https://t.me/elastoschina" target="_blank">
            <img class="social-icon" src="../../static/telegram.svg" />
          </a>
          <a href="https://twitter.com/Elastos_org" target="_blank">
...
<style lang="scss" scoped>
  ...
  .account-list {
    ...
    .account-item-icon {
      ...
      height: 32px;
      margin-right: 4px;
      background: url('../../static/main-header-icon.png') no-repeat;
