  ...
  <div class="token-list-wrapper">
    <div class="account-info">
      <div class="account-info-basic">
        ...
        <div class="account-info-name">DID:{{ did}}</div>
      </div>
    ...
    <div class="token-list-container">
      <ul class="token-list">
        <li class="token-item"
          ...
          <img class="token-item-icon" src="../../static/logo.svg"/>
          <span class="token-item-name">ELA</span>
        </li>
        <li class="token-item"
            :class="{
            active: activeRegId === null
          ...
          <img class="token-item-icon" src="../../static/logo.svg"/>
          <span class="token-item-name">ETH</span>
        </li>
        <li class="token-item"
