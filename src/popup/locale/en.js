export default {
  ...
  account: {
    ...
    send: {
      ...
      valuePlaceHolder: 'Input amount',
      descLabel: 'Comment（Optional）',
      addressInvalid: 'Input ELA mainnet address, ',
      testnetAddressInvalid: 'Input ELA testnet address',
      confirmButton: 'Confirm',
      confirmLoading: 'Submitting...',
      sendSuccess: 'Submit successfully',
      sendFailure: 'Failed to submit'
    ...
    dialog: {
      ...
      registerTip: 'Activating the wallet requires 0.0001 ELA, and the activation uses the ELA in the wallet.',
  ...
  wallet: {
    create: {
      password: {
        title: 'Set Password',
        tip: 'CyberLink doesn\'t store your wallet password and can\'t help you get it back, so keep it in mind.',
        password: 'Password',
        passwordPlaceholder: 'Please enter 6~20 characters',
  ...
  setting: {
    ...
    about: {
      ...
      name: 'CyberLink',
      links: 'Links',
      homepage: 'CyberLink Offical Website',
      devCenter: 'CyberLink Developer Portal'
    },
    password: {
  ...
  window: {
    contract: {
      title: 'ELA Contract Call',
      addressLabel: 'Address:',
      contractRegIdLabel: 'Contract RegID:',
      valueLabel: 'ELA amount:',
