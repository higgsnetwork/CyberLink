export default {
  ...
  account: {
    ...
    send: {
      ...
      valuePlaceHolder: '请输入转账金额',
      descLabel: '备注（选填）',
      addressInvalid: '请输入正确的ELA主网地址',
      testnetAddressInvalid: '请输入正确的ELA测试网地址',
      confirmButton: '确认转账',
      confirmLoading: '提交中...',
      sendSuccess: '转账提交成功',
      sendFailure: '转账提交失败'
    ...
    dialog: {
      ...
      registerTip: '激活钱包需要消耗 0.0001 ELA，激活钱包使用的是钱包内的 ELA。',
  ...
  wallet: {
    create: {
      password: {
        title: '设置密码',
        tip: 'CyberLink 不存储钱包密码，也无法帮您找回，请务必牢记。',
        password: '密码',
        passwordPlaceholder: '请输入6-20位字符',
        password2: '确认密码',
